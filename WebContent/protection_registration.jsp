			...
			<c:otherwise>	
				<sql:update dataSource="${dbCon}" var="result">
		            ...
		            <c:redirect url="protection_list.jsp" >
		                <c:param name="msg" value="Registry protection for new product successfully." />
				...
				<div class="modal-body">
					<div class="form-group">
						<label>User Name</label> <input type="text" name="username"
							class="form-control" value="${param.username}" required>
					...
					<div class="form-group">
						<label>Purchase Date</label> <input type="text" name="purchaseDate"
							class="form-control" placeholder="YYYY-MM-DD" required value="${param.purchaseDate}">
